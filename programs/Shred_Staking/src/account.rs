...
pub struct UserPool {
    ...
    pub staked_mints: [StakedData; STAKE_MAX_COUNT],   // 41 * 1000
...
impl UserPool {
    pub fn add_nft(
        ...
        self.staked_mints[idx].is_legendary = is_legendary;
    ...
    pub fn remove_nft(
        ...
        reward = (((now - last_reward_time) / EPOCH) as u64) * reward_amount * factor / 100;
